...
import { MSSA_ITEMS, OSHA_ITEMS, ISO_ITEMS, ROLES } from './data/frameworks.js?v=20260814_audit1';
import {
  renderDashboard, bindDashboardEvents, renderCompliance, bindComplianceEvents, openItemDrawer, resetFilter
} from './views-core.js?v=20260814_audit1';
import {
...
} from './views-ext.js?v=20260814_audit1';
