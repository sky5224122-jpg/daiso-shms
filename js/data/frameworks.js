...
export const MSSA_ITEMS = [
  ...
  },
  {
    ...
    evidenceFiles:['[본사] 직원사고 발생 시 대응 매뉴얼 포스터','[본사] 사고경위서 작성 매뉴얼(개정)','[본사] 화재 발생·비화재보 오작동 대응 절차_260625','[본사] 물류센터 소방설비 비교모델_260814','[본사] 심폐소생술 자료_26년','[본사] 허브센터 화재위험상품 분류체계 검토현황','[남사] 소방계획서','[남사] 상반기 소방대피훈련 결과기록지','[남사] 비상조치계획 시나리오(화재폭발·안전사고·감전)','[남사] 소방대피훈련 시나리오·실시결과서','[부산] 소방계획서','[부산] 상반기 소방훈련교육 실시결과 보고서','[부산] 폭발화재·감전재해예방·화재대비훈련·소방시설관리·화재시행동요령 지침서','[안성] 상반기 화재훈련 실시 결과']
  },
  {
...
export const OSHA_ITEMS = [
  ...
  { id:'OSHA-036', framework:'osha', group:'위험성평가', code:'법 제36조', title:'위험성평가 실시 및 기록 보존(3년)',
    ...
    evidenceFiles:['다이소웹하드 22~25년 자료','전자결재 등록','[본사] 25년 하반기 매장 위험성평가·비상대응훈련 실시결과','[본사] 25년도 상반기 매장 위험성평가 진행 가이드','[본사] 최초 위험성평가 NC청주점(개점 2026.04.23)','[본사] 최초 위험성평가 수원당수동점(개점 2026.03.06)','[본사] 위험성평가 교육자료(노무법인)','[남사] 정기위험성평가 결과보고서·서명지','[남사] 수시위험성평가 스캔본','[남사] 근로자 의견청취 결과 취합본','[부산] 정기위험성평가 결과보고서·감소대책 실행 목록','[부산] 수시위험성평가 보고','[부산] 위험성평가 유해요인 List','[안성] 위험성평가 결과보고서'] },
...
import { MSSA_FULL_ITEMS, OSHA_FULL_ITEMS } from './laws-full.js?v=20260905_teams';
