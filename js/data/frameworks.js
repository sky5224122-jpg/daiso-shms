...
export const OSHA_ITEMS = [
  ...
  { id:'OSHA-054', framework:'osha', group:'비상 · 사고대응', code:'법 제54~57조', title:'중대재해 발생 시 조치·보고 및 은폐 금지',
    ...
    companyStatus:'[26H1 평가] 전체 ●적정. 전사 각 현장 사고 발생 시 절차·기준에 따라 사고 보고 원활. 모든 사고는 사고경위서 전자결재 통해 사업주 보고(3일 이상 휴업 및 경미사고 포함). 매장은 점장·파트장 중심 1차 재해조사→재발방지대책 수립·개선, 안전보건팀은 연속재해·유해위험요인 개선 필요 매장 선별 조사. 허브센터도 절차·기준에 의거 사고 보고 및 처리',
    evidenceFiles:['AAD-HSHT-P-2022-018(2) 작업중지요청 지침서.docx','[본사] 26년 상반기 매장 사고원인조사 및 개선대책 결과보고서','[남사] 산업재해조사표·사고보고서','[부산] 사고보고서'] },
