import { DOCUMENT_SOURCE_FILES } from './document-files.js?v=20260908_recorddate1';
...
export const ROLES = {
  ...
  guest:   { key:'guest',   label:'게스트(전체 권한)', scope:'all' }
};
...
export const MSSA_ITEMS = [
  {
    ...
    evidenceFiles:['아성다이소 2026년 안전보건경영방침_260107.pdf','안전보건경영방침 게시 예시.jpg','[전자결재] 22~25년 각 반기 중대재해처벌법 이행 상태 평가 보고서','포탈 전자결재 등록(연도별 계획서)','[본사] 26년도 아성다이소(본사·매장) 연간 안전보건관리 계획서_260204','[본사] 2026_03_04 안전보건 이사회 의사록(연간 안전보건관리 계획 보고)','[본사] 26년 부서·팀 목표합의서(관리)_안전보건팀','[본사] 반기평가 실행율 종합_20260722','[남사] 26년 물류본부 안전보건관리 계획서','[남사] 26년 안전보건조직도','[부산] 26년 물류본부 안전보건관리 계획서','[부산] 부산허브센터 안전관리 조직도','[안성] 26년 물류본부 안전보건관리 계획서','[안성] 조직도'],
    reportLinks:[{label:'26H1 이행상태평가 보고서',url:'docs/reports/26H1_중처법_이행상태평가_보고서.pdf'},{label:'[본사] 2026 상반기 이행상태평가 보고서(수정)',url:'docs/evidence/본사·매장/MSSA-4-1_본사 2026 상반기 이행상태평가 보고서(수정).pdf'},{label:'[남사] 26년 안전보건조직도',url:'docs/evidence/남사/MSSA-4-1_남사 26년 안전보건조직도.pdf'},{label:'[남사] 26년 물류본부 안전보건관리 계획서',url:'docs/evidence/남사/MSSA-4-1_남사 26년 물류본부 안전보건관리 계획서.pdf'},{label:'[부산] 26년 부산허브센터 안전관리 조직도',url:'docs/evidence/부산/MSSA-4-1_부산 26년 부산허브센터 안전관리 조직도.pdf'},{label:'[안성] 조직도',url:'docs/evidence/안성/MSSA-4-1_안성 조직도.pdf'},{label:'[본사] 26년도 안전보건경영방침',url:'docs/evidence/본사·매장/MSSA-4-1_본사 26년도 안전보건경영방침.pdf'}]
  },
  {
    ...
    reportLinks:[{label:'[남사] 관리감독자 지정 보고',url:'docs/evidence/남사/MSSA-4-2_남사 관리감독자 지정 보고.pdf'},{label:'[안성] 관리감독자 지정명단',url:'docs/evidence/안성/MSSA-4-2_안성 관리감독자 지정명단.pdf'},{label:'[안성] 관리감독자 지정서',url:'docs/evidence/안성/MSSA-4-2_안성 관리감독자 지정서.pdf'}]
  },
  {
    ...
    evidenceFiles:['중처법 이행상태결과 보고서(반기1회)','[본사] 2026년 상반기 위험성평가·비상대응훈련 실행결과보고(최종본_20260716)','[본사] 2026 상반기 위험성평가 실시결과 보고_20260715','[본사] 2026년 하반기 정기위험성평가 실시안내_26_0828','[본사] 2026년 하반기 정기위험성평가앱 주요 변경사항 및 진행요청사항','[본사] 26년 상반기 위험성평가 점검사진','[본사] 26년 잠재위험요소 발굴 자료','[남사] 정기위험성평가 결과보고서','[남사] 수시위험성평가 스캔본','[남사] 근로자 의견청취 결과 취합본','[남사] 아차사고 발굴 보고서','[남사] 유해위험기계기구 설비대장','[남사] 안전검사 결과통지서','[남사] 지게차 운전 자격관리대장','[남사] 화학물질 점검 및 개선 결과보고','[부산] 정기위험성평가 결과보고서','[부산] 수시위험성평가 보고','[부산] 아차사고 사례 교안(월별)','[부산] 유해위험기계기구 목록표','[부산] 안전검사 결과통보서','[부산] MSDS 관리대장','[안성] 위험성평가 결과보고서'],
    reportLinks:[{label:'[남사] 정기위험성평가 결과보고서(25년)',url:'docs/evidence/남사/MSSA-4-3_남사 정기위험성평가 결과보고서(25년).pdf'},{label:'[남사] 유해위험기계기구 설비대장',url:'docs/evidence/남사/MSSA-4-3_남사 유해위험기계기구 설비대장.pdf'},{label:'[남사] 안전검사 결과통지서',url:'docs/evidence/남사/MSSA-4-3_남사 안전검사 결과통지서.pdf'},{label:'[남사] 화학물질 점검·개선 결과보고',url:'docs/evidence/남사/MSSA-4-3_남사 화학물질 점검·개선 결과보고.pdf'},{label:'[부산] 25년 부산허브센터 정기위험성평가 결과보고',url:'docs/evidence/부산/MSSA-4-3_부산 25년 부산허브센터 정기위험성평가 결과보고.pdf'},{label:'[부산] 유해위험기계기구 목록표',url:'docs/evidence/부산/MSSA-4-3_부산 유해위험기계기구 목록표.pdf'},{label:'[부산] MSDS 관리대장(설비)',url:'docs/evidence/부산/MSSA-4-3_부산 MSDS 관리대장(설비).pdf'}]
  },
  {
    ...
    companyStatus:'[26H1 평가] 본사·매장 ▲보완 / 남사 ▲보완 / 부산 ▲보완 / 안성 ▲보완. 재해예방 예산 중 안전보건 전담인력 인건비는 26년 상반기(1~6월, 중도퇴사자 포함 소득발생 전인원 기준) 집행실적이 명확히 집계됨: 본사 안전보건팀 6명 3.10억원(소득 1.91억+4대보험 0.23억+퇴직급여충당금 0.95억), 남사안전관리팀 19명 6.29억원, 부산안전관리팀 15명 6.41억원, 안성안전관리팀 15명 3.27억원 — 전사 합계 55명 19.07억원, 26년 예상 총액 38.13억원. 다만 시설·장비·개선활동 등 인건비 외 예산은 별도 계정코드·항목별 편성 체계가 아직 부재, 26년 6월 절차서·지침서(AAD-HSHT-P-2026-005 안전보건 예산 편성 및 집행 관리 절차서, SHP-19) 제정 완료. 26.08.01 안전보건공시 제도 시행으로 예산편성·집행 투명성 요구 가중. 물류 3센터 안전·보건·소방 예산 월별 편성·집행 중. [개선] ①인건비 외 시설·장비·교육 예산 항목별 세부편성 ②별도 계정코드 생성 ③반기 집행실적 정기 보고체계 확립',
    evidenceFiles:['[본사] 26년 상반기 안전보건 예산집행 내역','[본사] 안전보건예산 인력 분야 인건비 계상기준_260729','[본사] 전사 안전보건 조직 인력 인건비_260826','[본사] 260422 안전보건공시제도 보고','[본사] 안전보건공시제 관련 국회 발의안 및 통과 현황_260421','[남사] 물류본부 안전보건예산 월별 집행내역','[부산] 물류본부 안전보건예산 월별 집행내역'],
    reportLinks:[{label:'[본사] 26년 상반기 안전보건 예산집행 내역',url:'docs/evidence/본사·매장/MSSA-4-4_본사 26년 상반기 안전보건 예산집행 내역.pdf'},{label:'[전사] 26년 상반기 안전보건 전담인력 인건비 집행실적',url:'docs/evidence/본사·매장/MSSA-4-4_전사 안전보건 조직 인력 인건비_260826.pdf'}]
  },
  {
  ...
  },
  {
    ...
    evidenceFiles:['AAD-HSHT-P-2022-018(3) 근로자 참여 및 협의 절차서.docx','[본사] 종사자 의견청취 실행 계획 보고서','[본사] 근로자 의견 청취 취합DB','[남사] 26년 2분기 산업안전보건위원회 회의록','[남사] 고충처리 접수 현황','[남사] 26년 2분기 노사협의회 회의록','[남사] 정기위험성평가 설명회·결과보고','[부산] 26년 1분기 산안위 회의자료·회의록','[부산] 관리감독자 안전보건 회의록','[부산] 정기위험성평가 실시 계획','[안성] 26년 3분기 산업안전보건위원회'],
    reportLinks:[{label:'[남사] 2분기 산안위 회의록',url:'docs/evidence/남사/MSSA-4-7_남사 2분기 산안위 회의록.pdf'},{label:'[남사] 2분기 노사협의회 회의록',url:'docs/evidence/남사/MSSA-4-7_남사 2분기 노사협의회 회의록.pdf'},{label:'[부산] 26년 1분기 산안위 회의록',url:'docs/evidence/부산/MSSA-4-7_부산 26년 1분기 산안위 회의록.pdf'},{label:'[부산] 26년 1분기 산안위 회의자료',url:'docs/evidence/부산/MSSA-4-7_부산 26년 1분기 산안위 회의자료.pdf'},{label:'[안성] 26년 3분기 산업안전보건위원회',url:'docs/evidence/안성/MSSA-4-7_안성 26년 3분기 산업안전보건위원회.pdf'}]
  },
  {
    ...
    companyStatus:'[26H1 평가] 본사·매장 ▲보완 / 남사 ▲보완 / 부산 ●적정 / 안성 ●적정. 본사는 「화재 발생·비화재보 오작동 대응 절차」(26.06.22 제정, 인사총무본부 안전보건팀)를 마련하여 대피 판단기준·관리감독자 역할·1차/2차 집결지(본사 1층→독골공원)·보고체계(방재실→총무팀→안전보건팀→부문장→대표이사)를 구체화함. 상반기 자위소방대 교육·실습 진행, 하반기 화재 대피 시나리오 실습 계획. 매장별 비상대응 시나리오(화재·심정지·감전) 외 정전 등 추가 시나리오 다양화 필요. 부산센터 작업중지권 절차서 개정·교육 완료, 물류본부 공통 비상절차서 표준화 추진. [개선] ①매장 비상대응 시나리오 다양화 ②남사센터 작업중지권 근로자 인식개선 교육 ③물류본부 공통 비상조치 절차서 표준화 ④본사 화재대응 절차를 SHP-13 비상시 대비 및 대응 절차서의 공식 부속서(별첨)로 편입',
    evidenceFiles:['[본사] 2026_상반기_비상대응훈련_결과보고서','[본사] 2026년 상반기 위험성평가·비상대응훈련 실행결과보고(최종본_20260716)','[본사] 26년 상반기 비상대응훈련 사진','[본사] 비상대응훈련 앱 실행 가이드','[본사] 23~25년도 비상대응훈련 실시 이력(본사·매장·CPR)','[본사] 직원사고 발생 시 대응 매뉴얼 포스터','[본사] 사고경위서 작성 매뉴얼(개정)','[본사] 화재 발생·비화재보 오작동 대응 절차_260625','[본사] 물류센터 소방설비 비교모델_260814','[본사] 심폐소생술 자료_26년','[본사] 허브센터 화재위험상품 분류체계 검토현황','[남사] 소방계획서','[남사] 상반기 소방대피훈련 결과기록지','[남사] 비상조치계획 시나리오(화재폭발·안전사고·감전)','[남사] 소방대피훈련 시나리오·실시결과서','[부산] 소방계획서','[부산] 상반기 소방훈련교육 실시결과 보고서','[부산] 폭발화재·감전재해예방·화재대비훈련·소방시설관리·화재시행동요령 지침서','[안성] 상반기 화재훈련 실시 결과'],
    reportLinks:[{label:'[본사] 화재 발생·비화재보 오작동 대응 절차(26.06.22)',url:'docs/evidence/본사·매장/MSSA-4-8_본사 화재 발생·비화재보 오작동 대응 절차_260625.pdf'},{label:'[남사] 상반기 소방대피훈련 결과기록지',url:'docs/evidence/남사/MSSA-4-8_남사 상반기 소방대피훈련 결과기록지.pdf'},{label:'[부산] 상반기 소방훈련교육 실시결과 보고서',url:'docs/evidence/부산/MSSA-4-8_부산 상반기 소방훈련교육 실시결과 보고서.hwp'},{label:'[안성] 상반기 화재훈련 실시 결과',url:'docs/evidence/안성/MSSA-4-8_안성 상반기 화재훈련 실시 결과.pdf'}]
  },
  {
    ...
    evidenceFiles:['[본사] 26년 상반기 도급 적격업체평가표','[본사] 아성다이소 매장 인테리어 공사 안전관리 R&R 보고_260605','[본사] 도급 산재 예방조치(순회점검·협의체·합동안전점검) 자료','[남사] 적격수급업체 평가','[남사] 도급사 협의체 및 합동점검·순회점검','[남사] 협력사 협의체 실시기록','[부산] 적격수급업체 평가표','[부산] 안전보건협의체 자료·서명지','[부산] 안전보건 합동점검 체크리스트','[안성] 도급사 안전보건협의체·합동점검·순회점검일지'],
    reportLinks:[{label:'[남사] 도급사 협의체 및 합동점검',url:'docs/evidence/남사/MSSA-4-9_남사 도급사 협의체 및 합동점검.pdf'},{label:'[남사] 협력사 협의체 실시기록',url:'docs/evidence/남사/MSSA-4-9_남사 협력사 협의체 실시기록.pdf'},{label:'[남사] 남사허브센터 도급사 현장순회 점검기록',url:'docs/evidence/남사/MSSA-4-9_남사 남사허브센터 도급사 현장순회 점검기록.pdf'},{label:'[부산] 안전보건협의체 자료',url:'docs/evidence/부산/MSSA-4-9_부산 안전보건협의체 자료.pdf'},{label:'[부산] 안전보건 합동점검 체크리스트',url:'docs/evidence/부산/MSSA-4-9_부산 안전보건 합동점검 체크리스트.pdf'},{label:'[안성] 도급사 안전보건협의체',url:'docs/evidence/안성/MSSA-4-9_안성 도급사 안전보건협의체.pdf'},{label:'[안성] 합동점검',url:'docs/evidence/안성/MSSA-4-9_안성 합동점검.pdf'}]
  },
  {
    ...
    cycle:'반기 1회', docRefs:['SHP-06','SHP-15','SHP-25','SHP-26'], isoRefs:['6.1.3','9.1.2'], severity:'critical',
    requiredDocs:["점검계획 수립 문서","점검결과 보고 관련 문서","점검결과 조치 및 이행상태확인 관련 문서"],
    companyStatus:'[26H1 평가] 본사·매장 ●적정 / 남사 ●적정 / 부산 ●적정 / 안성 ●적정. 관계법령 반기 점검·자체점검 실시, 직무·정기 안전보건교육(TBM 운영), 법정 안전검사 수검 등 관계법령 의무이행 관리 중. 개정 법규 상시 모니터링, 법규관리검토서 기록관리, 반기 이행 평가 중. AAD-HSHT-P-2026-001(26.05.01 제정) 「중대재해처벌법 이행상태평가 절차서」에 시행령 제4조 9개 호·제5조 평가방법론이 규정됨(평가팀 구성→계획수립→자료수집→현장실태조사→5점 척도 평가(우수~불량)→결과보고·승인→개선조치의 6단계, 별지 서식 5종). ※ 참고: 동일 주제로 SHP-25(AAD-HSHT-P-2026-012 「반기 점검 및 경영책임자 보고 절차서」)도 별도 운영 중 — 두 문서의 관계(평가방법론 vs 경영보고 절차로 상호 보완인지, 후속 개정으로 하나가 대체된 것인지)를 회사에서 확인·정리 필요',
    evidenceFiles:['26년 상반기 중처법 이행상태평가 보고서','26년 상반기 허브센터 법규준수 점검결과보고','AAD-HSHT-P-2026-001 중대재해처벌법 이행상태평가 절차서','[본사] 산업안전보건법령요지_26_0821(아성다이소용)','[본사] 26년 안전보건 관련 법규 및 제도 변경사항 검토_260102','[본사] 25년 하반기 통합점검 결과','[본사] 통합점검 운영 기준안(101건)_260303','[허브] 물류본부 안전보건관리 법규준수 점검결과보고'],
    reportLinks:[
      ...
      {label:'AAD-HSHT-P-2026-001 이행상태평가 절차서(26.05.01 제정)',url:'docs/evidence/본사·매장/MSSA-5-1_AAD-HSHT-P-2026-001_이행상태평가 절차서.pdf'}
    ]
  },
  {
  ...
  },
  {
    ...
    reportLinks:[{label:'[부산] 집체교육(주,야간) 결과 서명지',url:'docs/evidence/부산/MSSA-5-3_부산 집체교육(주,야간) 결과 서명지.pdf'},{label:'[부산] TBM교육자료 5월(현장직)',url:'docs/evidence/부산/MSSA-5-3_부산 TBM교육자료 5월(현장직).pdf'}]
  },
  {
...
export const OSHA_ITEMS = [
  ...
  { id:'OSHA-024', framework:'osha', group:'참여 · 협의', code:'법 제24조', title:'산업안전보건위원회 구성·운영(분기 1회)',
    ...
    evidenceFiles:['산업안전위원회 회의록 모음','[본사] 26년 상반기 안전보건위원회 회의록','[본사] 25년도 4분기 산업안전보건위원회 회의록_251128','[본사] 26년도 산업안전보건위원회 회의록_260625','[본사] 26년 본사·허브센터 안전보건협의회 회의록_260128','[본사] 산안위 및 노사협의회 조직도_본사(매장)·허브센터_251229','[남사] 26년 2분기 산안위 회의록','[남사] 26년 2분기 노사협의회 회의록','[부산] 26년 1분기 산안위 정기회의 자료·회의록','[안성] 26년 3분기 산업안전보건위원회'],
    reportLinks:[{label:'[본사] 26년 상반기 안전보건위원회 회의록',url:'docs/evidence/본사·매장/OSHA-024_본사 26년 상반기 안전보건위원회 회의록.pdf'}] },
  ...
  { id:'OSHA-025', framework:'osha', group:'참여 · 협의', code:'법 제25~26조', title:'안전보건관리규정 작성·게시 및 변경 시 동의',
    ...
    evidence:['안전보건관리규정 원본','게시 증빙','제·개정 시 심의·의결 회의록'], cycle:'연 1회', docRefs:['SHM-01','SHP-09'], isoRefs:['7.5'], severity:'high',
    penalty:'과태료 1천만원 이하 (법 제175조)',
    ...
    evidenceFiles:['AAD-HSHT-M-2021-002(7) 안전보건관리규정_26_0826.docx'] },
  ...
  { id:'OSHA-029', framework:'osha', group:'교육', code:'법 제29조', title:'근로자 안전보건교육(정기·채용시·변경시·특별)',
    ...
    evidenceFiles:['www.asungcorp.com','26년도 아성다이소(본사,매장) 연간 안전보건관리 계획서 260204.pptx','[본사] 26년 상반기 매장 하나데이(관리감독자) 안전보건교육 교안','[본사] 26년 매장 하나데이 안전보건교육 교안_260519','[본사] 25년도 경력사원 신규입사자 교육','[본사] 매장 채용시 안전보건교육 전자서명 안내','[본사] TBM 2026년 연간집계','[본사] 26년 매장 TBM 실행 결과','[본사] 전산 TBM 사용 가이드','[남사] 정기안전보건교육 서명지 및 TBM 교육서명지','[남사] 위험성평가 교육 서명지','[남사] 사고전파교육 서명지','[부산] 집체교육(주·야간) 결과 서명지','[부산] TBM교육자료','[부산] 위험성평가 담당자 교육 서명지'] },
  ...
  { id:'OSHA-034', framework:'osha', group:'정보 제공', code:'법 제34조', title:'법령 요지 및 안전보건관리규정 게시',
    ...
    companyStatus:'[26H1 평가] 법령 요지 및 안전보건관리규정 최신본 1월 게시 완료. 8월 개정본(260821) 배포. 게시 증빙자료 등록 필요',
    evidenceFiles:['산업안전보건법령요지_26_0107(아성다이소용).pdf','산업안전보건법령요지_26_0821(아성다이소용).pdf'] },
  ...
  { id:'OSHA-036', framework:'osha', group:'위험성평가', code:'법 제36조', title:'위험성평가 실시 및 기록 보존(3년)',
    ...
    evidenceFiles:['다이소웹하드 22~25년 자료','전자결재 등록','[본사] 2026 상반기 위험성평가 실시결과 보고_20260715','[본사] 2026년 상반기 위험성평가·비상대응훈련 실행결과보고(최종본)','[본사] 2026년 하반기 정기위험성평가 실시안내_26_0828','[본사] 위험성평가 앱 실행 가이드','[본사] 26년 상반기 위험성평가 점검사진','[본사] 25년 하반기 매장 위험성평가·비상대응훈련 실시결과','[본사] 25년도 상반기 매장 위험성평가 진행 가이드','[본사] 최초 위험성평가 NC청주점(개점 2026.04.23)','[본사] 최초 위험성평가 수원당수동점(개점 2026.03.06)','[본사] 위험성평가 교육자료(노무법인)','[남사] 정기위험성평가 결과보고서·서명지','[남사] 수시위험성평가 스캔본','[남사] 근로자 의견청취 결과 취합본','[부산] 정기위험성평가 결과보고서·감소대책 실행 목록','[부산] 수시위험성평가 보고','[부산] 위험성평가 유해요인 List','[안성] 위험성평가 결과보고서'],
    reportLinks:[{label:'[안성] 순회점검일지',url:'docs/evidence/안성/OSHA-036_안성 순회점검일지.pdf'},{label:'[안성] 작업시작전점검일지',url:'docs/evidence/안성/OSHA-036_안성 작업시작전점검일지.pdf'}] },
  ...
  { id:'OSHA-039A', framework:'osha', group:'보건관리', code:'안전보건규칙 제657조', title:'근골격계 유해요인조사',
    ...
    evidenceFiles:['AAD-HSHT-G-2022-010(2) 근골격계질환 예방 지침서.docx','23년 근골격계 부담작업 유해요인조사 종합보고서.pdf','23년 근골격계유해요인조사 결과보고서_240108','[본사] 근골격계 유해요인조사 증상조사표','[본사] 근골격계 조사 결과보고서(전문기관 위탁 2건 — 명동역점 외 9개점, 난곡사거리점 외 26개점)','[남사] 2025년 남사센터 근골격계부담작업 유해요인조사 결과보고','[부산] 2023년 근골격계부담작업 유해요인 정기조사 결과보고서'] },
  ...
  { id:'OSHA-041', framework:'osha', group:'현장 안전조치', code:'법 제41조', title:'고객응대근로자 건강장해 예방조치(감정노동)',
    ...
    evidenceFiles:['(매장 부착)고객응대근로자 보호 조치 POP.pdf','AAD-TCSD-P-2019-001(9) 내부고객 보호 절차서.pdf','[본사] 고객폭언·건강장해 예방 조치 자료','[본사] 매장 고객사고 발생 현황(누적관리)','[본사] 매장 사고관리 프로세스 현황 및 개선방향_260128'] },
  ...
  { id:'OSHA-054', framework:'osha', group:'비상 · 사고대응', code:'법 제54~57조', title:'중대재해 발생 시 조치·보고 및 은폐 금지',
    ...
    evidenceFiles:['AAD-HSHT-P-2022-018(2) 작업중지요청 지침서.docx','[본사] 26년 상반기 매장 사고원인조사 및 개선대책 결과보고서','[본사] 산업재해 현황_26년8월(본사·매장 산재승인 통계)','[본사] 산재현황 촉탁직 재해현황_260902','[본사] 25년 산재승인 현황','[본사] 산업재해통계관리표 V6(자동화 통합문서)','[본사] 사고경위서 재해 현황표(실무)','[본사] 사고경위서 작성 매뉴얼·가이드 교안','[본사] 중상해 재해 재발방지 신속 기술지원 보고서','[남사] 산업재해조사표·사고보고서','[부산] 사고보고서'] },
  ...
  { id:'OSHA-129', framework:'osha', group:'보건관리', code:'법 제129~130조', title:'일반건강진단 및 특수건강진단 실시',
    ...
    companyStatus:'수검 관리 명단: 21,22년도 필요. 결과지: HR시스템에서 관리. GC케어 검진대행 서비스 운영(26년2월 계약). 근로자 일반건강진단 운영 개선 방안 수립(260105). 고위험군 관리대장 운영',
    evidenceFiles:['AAD-HSHT-G-2022-002(2) 건강진단 지침서.docx','25년도 일반건강검진 및 유소견자 사후관리 결과 보고 件.pdf','[본사] 26년 보건관리 계획_0313','[본사] GC케어 건강검진 운영 서비스_26년2월','[본사] 근로자 일반건강진단 운영 개선 방안_260105','[본사] 고위험군 관리대장'] },
...
export const ISO_ITEMS = [
  ...
  { id:'ISO-9.2', framework:'iso', group:'9. 성과평가', code:'9.2', title:'내부심사',
    ...
    companyStatus:'[26H1 실행문서 평가] ▲보완. 25년 매장 내부심사 체크리스트(250528) 확인. 26년 상반기 허브센터 내부심사(중대재해처벌법 대응 이행평가) 6월 실시 및 보고서 등록 완료. 매장 내부심사 결과보고서·국제인증기준 사후심사 결과는 하반기 확인 필요',
    evidenceFiles:['26년 상반기 허브센터 내부심사_중대재해처벌법 대응 이행평가(26.06월)'],
    reportLinks:[
      {label:'26H1 허브센터 내부심사 결과', url:'docs/reports/26H1_허브센터_법규준수_점검결과보고.pdf'}
    ] },
...
export const DOC_MASTER = [
  ...
  { docNo:'SHP-26', type:'procedure', title:'중대재해처벌법 이행상태평가 절차서', category:'성과평가', companyDocNo:'AAD-HSHT-P-2026-001(1)',
    purpose:'중대재해처벌법 시행령 제4조·제5조 각 호의 안전보건 확보의무 이행상태를 평가팀 구성·현장실태조사·5점 척도 평가·결과보고·개선조치의 6단계로 평가하는 방법을 규정한다. ※ SHP-25(경영책임자 보고 절차서)와 주제가 겹쳐 상호관계 확인 필요.', isoRefs:['9.1.2'], lawRefs:['MSSA-5-1'] },
...
import { MSSA_FULL_ITEMS, OSHA_FULL_ITEMS } from './laws-full.js?v=20260908_recorddate1';
