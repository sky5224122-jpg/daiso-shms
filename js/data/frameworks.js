...
export const DOC_MASTER = [
  ...
  { docNo:'SHP-02', companyDocNo:'AAD-HSHT-P-2022-003(6)', type:'procedure', title:'안전보건방침 및 목표관리 절차서', category:'리더십',
    purpose:'안전보건방침 수립·공표 및 연간 목표 설정·평가 방법을 규정한다.', isoRefs:['5.2','6.2'], lawRefs:['MSSA-4-1','OSHA-014'] },
  { docNo:'SHP-03', companyDocNo:'AAD-HSHT-P-2022-017(6)', type:'procedure', title:'역할·책임·권한 및 선임관리 절차서', category:'리더십',
    purpose:'계층별 R&R, 법정 선임자 배치 및 업무수행 평가 방법을 규정한다.', isoRefs:['5.3'], lawRefs:['MSSA-4-2','MSSA-4-5','MSSA-4-6','OSHA-015','OSHA-016','OSHA-017'] },
  { docNo:'SHP-04', companyDocNo:'AAD-HSHT-P-2022-018(4)', type:'procedure', title:'근로자 협의 및 참여 절차서', category:'리더십',
    purpose:'산업안전보건위원회 운영과 종사자 의견청취·개선 절차를 규정한다.', isoRefs:['5.4'], lawRefs:['MSSA-4-7','OSHA-024'] },
  { docNo:'SHP-05', companyDocNo:'AAD-HSHT-P-2022-001(4)', type:'procedure', title:'위험성평가 절차서', category:'기획',
    purpose:'유해·위험요인 파악, 위험성 추정·결정, 감소대책 수립 및 이행 확인 방법을 규정한다.', isoRefs:['6.1.1','6.1.2','6.1.4'], lawRefs:['MSSA-4-3','OSHA-036'] },
  { docNo:'SHP-06', companyDocNo:'AAD-HSHT-P-2022-002(5)', type:'procedure', title:'법규 및 기타 요구사항 관리 절차서', category:'기획',
    purpose:'적용 법규 파악·등록·개정 모니터링 및 전달 방법을 규정한다.', isoRefs:['6.1.3'], lawRefs:['MSSA-5-1'] },
  { docNo:'SHP-07', companyDocNo:'AAD-HSHT-P-2022-004(6)', type:'procedure', title:'안전보건 교육훈련 절차서', category:'지원',
  ...
  { docNo:'SHP-09', companyDocNo:'AAD-HSHT-P-2022-006(3), AAD-HSHT-P-2022-007(4)', type:'procedure', title:'문서 및 기록관리 절차서', category:'지원',
    purpose:'문서의 제·개정·배포·폐기와 기록의 법정 보존연한 관리 방법을 규정한다.', isoRefs:['7.5'], lawRefs:['OSHA-164','OSHA-025'] },
  { docNo:'SHP-10', companyDocNo:'AAD-HSHT-P-2022-008(3)', type:'procedure', title:'작업 안전관리 절차서', category:'운용',
  ...
  { docNo:'SHP-12', companyDocNo:'AAD-HSHT-P-2022-010(4)', type:'procedure', title:'도급·용역·위탁 안전보건 관리 절차서', category:'운용',
  ...
  { docNo:'SHP-14', companyDocNo:'AAD-HSHT-P-2022-012(6)', type:'procedure', title:'성과 모니터링 및 측정 절차서', category:'성과평가',
    purpose:'안전보건 선행·후행 지표의 측정·분석·보고 방법을 규정한다.', isoRefs:['9.1.1'], lawRefs:[] },
  { docNo:'SHP-15', companyDocNo:'AAD-HSHT-P-2022-002(5)', type:'procedure', title:'준수평가 절차서', category:'성과평가',
  ...
  { docNo:'SHP-17', companyDocNo:'AAD-HSHT-P-2026-012(0)', type:'procedure', title:'경영검토 절차서', category:'성과평가',
    purpose:'최고경영자의 경영검토 입력·출력 항목과 실시 주기를 규정한다.', isoRefs:['9.3'], lawRefs:['OSHA-014'] },
  { docNo:'SHP-18', companyDocNo:'AAD-HSHT-P-2022-015(3), AAD-HSHT-P-2022-019(4)', type:'procedure', title:'사건조사·부적합 및 시정조치(CAPA) 절차서', category:'개선',
    purpose:'사고·아차사고·부적합의 조사, 근본원인 분석, 시정조치 및 효과성 검증 방법을 규정한다.', isoRefs:['10.1','10.2','10.3'], lawRefs:['OSHA-054'] },
  { docNo:'SHP-19', companyDocNo:'AAD-HSHT-P-2026-005(0)', type:'procedure', title:'안전보건 예산관리 절차서', category:'지원',
  ...
  { docNo:'SHI-01', companyDocNo:'AAD-HSHT-G-2022-006(4)', type:'instruction', title:'매장 일상 안전점검 지침서', category:'현장', purpose:'점장(관리감독자)이 매일 수행하는 안전점검 항목과 방법을 정한다.', isoRefs:['8.1.1'], lawRefs:['OSHA-016'] },
  { docNo:'SHI-02', companyDocNo:'AAD-HSHT-G-2022-007(4)', type:'instruction', title:'롤테이너·중량물 취급 안전 지침서', category:'현장', purpose:'롤테이너 이동·적재 및 중량물 취급 시 부딪힘·끼임·근골격계 재해 예방 방법을 정한다.', isoRefs:['8.1.2'], lawRefs:['OSHA-039'] },
  { docNo:'SHI-03', companyDocNo:'AAD-HSHT-G-2022-008(4)', type:'instruction', title:'사다리·고소작업 안전 지침서', category:'현장', purpose:'진열대 상단 작업 등 사다리 사용 시 추락 예방 방법을 정한다.', isoRefs:['8.1.2'], lawRefs:['OSHA-037'] },
  ...
  { docNo:'SHI-06', companyDocNo:'AAD-HSHT-G-2022-009(4)', type:'instruction', title:'전기·설비 안전 지침서', category:'현장', purpose:'분전반·조명·냉난방 설비의 안전점검과 감전 예방 방법을 정한다.', isoRefs:['8.1.2'], lawRefs:['OSHA-037'] },
  { docNo:'SHI-07', companyDocNo:'AAD-HSHT-G-2022-004(4)', type:'instruction', title:'개인보호구 지급 및 관리 지침서', category:'현장', purpose:'작업별 보호구 선정·지급·착용·폐기 기준을 정한다.', isoRefs:['8.1.2'], lawRefs:['OSHA-037'] },
  { docNo:'SHI-08', companyDocNo:'AAD-HSHT-G-2022-019(5)', type:'instruction', title:'응급처치 및 구호 지침서', category:'비상', purpose:'재해자 발생 시 응급처치, 119 신고, 병원 인계 절차를 정한다.', isoRefs:['8.2'], lawRefs:['MSSA-4-8'] },
  ...
  { docNo:'SHI-11', companyDocNo:'AAD-HSHT-G-2026-025(0)', type:'instruction', title:'혹서기·혹한기 건강장해 예방 지침서', category:'보건', purpose:'온열·한랭 질환 예방을 위한 물·그늘·휴식 관리 기준을 정한다.', isoRefs:['8.1.2'], lawRefs:['OSHA-039'] },
  { docNo:'SHI-12', companyDocNo:'AAD-HSHT-G-2022-018(3)', type:'instruction', title:'작업중지권 행사 지침서', category:'비상', purpose:'급박한 위험 시 근로자·관리감독자의 작업중지 판단과 재개 승인 절차를 정한다.', isoRefs:['7.3','8.2'], lawRefs:['OSHA-051'] },
